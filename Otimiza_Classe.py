...
class otimizador:
    ...
    def gera_pontos(quantidade_pontos, upper = True, anterior = False, sigma = 0.01):
        ...
        for i in range(quantidade_pontos):
            if i == quantidade_pontos-1:
                ...
                if anterior == False:
                    vety[1] = random.uniform(0.02, 0.12)
                    anterior = vety[1]
                else:
                    vety[1] = -(anterior)
                    anterior = False
    ...
    def evolui(pais, num_filhos, ind_mutacao = 0.5):
